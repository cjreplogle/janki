...
>[!WARNING]
> **Lots of features are only functional on macOS and untested on Windows devices...** Will properly port some core features to Windows as a separate fork when I find the time / people ask for them.
