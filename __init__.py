...
from .src import card_timer, css, diagnostics, focus, gamepad, glass, hud, keytap, pomodoro, settings_dialog, tray
...
# GlassSettings above.
try:
    from .src.integrations import lectures  # noqa: F401
